      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Information of Specific Product</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                       <div class="card-header"> <h5 class="card-title">Product Information</h5></div>
                        ...
                        <div class="card-footer">
                            <a class="btn btn-sm btn-success" href="{{route('dashboard')}}"><i class="fa fa-arrow-left"></i>Back</a>
                        </div>
                    </div>
                </div>

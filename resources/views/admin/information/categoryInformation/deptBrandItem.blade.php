    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <h1 class="m-0 text-success">{{$Department}} Deparment & {{$Brand}} Brand & {{$Item}} Item  Has {{$TotalProduct}} Products </h1>
          <br>
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> Products List of {{$Department}} Department & {{$Brand}} Brand & {{$Item}} Item  </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->

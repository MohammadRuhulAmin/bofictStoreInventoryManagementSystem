    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <h1 class="m-0 text-success">{{$Category}} Category  & {{$Subcategory}} Subcategory & {{$Item}} Item  Has {{$TotalProduct}} Products </h1>
          <br>
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> Products List of {{$Category}} Category  & {{$Subcategory}} Subcategory & {{$Item}} Item  </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->

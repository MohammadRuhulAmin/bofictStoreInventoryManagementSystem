  ...
  <div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Create a New Accessory </h3>
     
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form" action="{{route('accessories.store')}}" method="post">
        @csrf 
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputEmail1">Accessory Name <span class="text-danger">*</span> </label>
            <input type="text" class="form-control" id="" name="accessoryName" placeholder="Accessory Name ">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="" name="accessoryFirstProperty" placeholder="Accessory First Property ">
          </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Accessory Second Property </label>
                <input type="text" class="form-control" id="" name="accessorySecondProperty" placeholder="Accessory Second Property ">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Accessory Third Property </label>
                <input type="text" class="form-control" id="" name="accessoryThirdProperty" placeholder="Accessory Third Property ">
            </div>
        </div>
        <!-- /.card-body --> 

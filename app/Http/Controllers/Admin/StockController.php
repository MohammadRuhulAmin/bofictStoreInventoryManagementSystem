...
class StockController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.stocks.edit',compact('categorys','subcategorys','brands','items','types','stock'));
    ...
    public function update(Request $request, $id)
    {
        ...
        // for category ,  subcategory , brand , item , type 
            ...
            $stock->stockBalance = $totalStock;
            $stock->save();
           flash('Product item is Updated &  Recorded in Stock!')->success();
           return back();
        }
        else {
            flash('We are working on it , Please let us know ! ')->error();
    ...
    public function destroy($id)
    {
        $stock = Stock::findOrFail($id);
        $stock->delete();
        flash('Product item is Deleted Successfully')->success();
        return back();
